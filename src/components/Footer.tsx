  ...
  return (
    <div className="flex flex-col gap-5 items-center justify-center p-5 bg-black">
      <div className="flex gap-10 items-center justify-center">
        <Link href="https://www.youtube.com/channel/UC6GsLGbDqcQN4lAB4dmP3Qg" target="_blank" className="bg-white p-2 rounded-full hover:scale-110 transition-[0.2s]">
        ...
        <Link href="https://www.instagram.com/sps_iskra/" target="_blank" className="bg-white p-2 rounded-full hover:scale-110 transition-[0.2s]">
